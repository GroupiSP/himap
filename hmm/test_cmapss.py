...
train = pd.read_csv('example_data/train_FD001_disc_20_mod.csv', sep=';') #the discretized data starts from 0, to work with HMM it has to start from 1
test = pd.read_csv('example_data/test_FD001_disc_20_mod.csv', sep=';')
